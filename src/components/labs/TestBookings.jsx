    ...
    const fetchBookingDetails = async () => {
      try {
        ...
        const response = await axios.post(
          "https://server.bookmyappointments.in/api/bma/hospital/test/bookingdetails",
          {
            testid: id,
          },
          {
    ...
    <div key={item.booking._id} style={styles.card}>
      ...
      <div style={styles.cardContent}>
        <div style={styles.infoRow}>
          <span className="material-icons" style={{ color: "#2BB673" }}>
            person
          </span>
        ...
        <p style={styles.bookedOn}>
          Booked on: {item.booking.bookedOn.split("T")[0]}
        </p>
      </div>
    </div>
  );
